...
function Edit() {
      ...
      try {
        ...
        if(response.ok){
          ...
          if(data.id){
            ...
            const response = await fetch(`https://whysonmymind-backend-production.up.railway.app/${data.id}`,{  credentials:'include', })
  ...
  const handleContentChange = async (newValue) => {
    ...
    if(isNewPostNeeded){
      ...
      const response = await fetch("https://whysonmymind-backend-production.up.railway.app/create",
      {method:'POST', 
      headers: {
    ...
    const response = await fetch(`https://whysonmymind-backend-production.up.railway.app/update/content/${bostID}`,{  
      method:'PATCH',
      credentials: 'include',
      headers: {
        'Content-Type': 'application/json' // Specify the content type
  ...
  const PostContent = async () =>{
     const response = await fetch('https://whysonmymind-backend-production.up.railway.app/submit',{
      credentials:'include',
      method:'PATCH',
      headers: {
        'Content-Type': 'application/json' // Specify the content type
